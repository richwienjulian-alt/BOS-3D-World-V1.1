/* Mission BOS Build 013M.18 preparation-only UX contract. No production implementation. */
(function(root){
  "use strict";
  root.MISSION_BOS_BUILD_013M18_UX_CONTRACT = Object.freeze({
  "build": "013M.18",
  "mode": "PREPARATION_ONLY",
  "sourceBuild": "Mission-BOS-Build-013M.17",
  "sourceArchiveSha256": "ea46e0102b346fa8ca21990da6e090e58a721686d76a948b485ab1c0372e4b92",
  "touch": {
    "noVisibleTouchMode": true,
    "desktopControlsPreserved": [
      "WASD",
      "Q/E",
      "mouse-drag",
      "mouse-wheel",
    ...
    "oneFingerGesture": "GROUND_PLANE_PAN",
    "tapThresholdCssPx": 8,
    "tapMaxDurationMs": 350,
    "pinchGesture": "FOV_ZOOM",
    "minFov": 36,
    "maxFov": 78,
    "touchRotationInFirstBuild": false,
    "dashboardControls": {
  ...
  "incidentCard": {
    ...
    "missionNumbersAllowedIn": [
      "mission selector",
      "primary mission CTA",
      "technical/debug surfaces"
    ],
    "missionNumbersForbiddenIn": [
      "status badge",
      "current phase",
      "description"
    ],
    "titles": {
      "MISSION_001": "Wohnungsbrand Innenstadt",
      "MISSION_002": "Medizinischer Notfall an der Arena",
      "MISSION_003": "Wasserleitungsleck Innenstadt",
      "MISSION_004": "Verkehrsunfall Ringstraße Nord"
    },
    "missions": {
      "MISSION_001": {
        "states": {
    ...
    "missionControllerChangesAllowed": false
  },
  "protected": {
    "missionStateMachines": true,
    "networkAlgorithms": true,
    "presenterProfiles013M17": true,
    "desktopInputSemantics": true
  }
});
